                        ...
                        <div class="col-md-offset-5 col-md-7 slider-height">
                            <div class="slide-text">
                                ...
                                <div class="cap-sub-title wow bounceInDown mb-30 text-white" data-wow-duration="1.5s" data-wow-delay="0s">
                                    <p>Check out our latest summer collection order online get 30% off on every item this summer</p>
                                </div>
                                <div class="cap-shop wow bounceInUp" data-wow-duration="2s" data-wow-delay=".5s">
                                    <a href="Cart.php" class="button extra-small text-uppercase">
                                        <span>Shop now</span>
                                    </a>
                                </div>                      
                            </div>
                            ...
                            <div role="tabpanel" class="tab-pane fade in active" id="arrival">
                                <div class="col-md-3 col-sm-4">
                                    <div class="single-product mb-40">
                                        ...
                                        <div class="product-content text-center text-uppercase">
                                            <a href="product-details.php" title="Ripcurl Furry Fleece">Ripcurl Furry Fleece</a>
                                ...
                                <div class="col-md-3 col-sm-4">
                                    ...
                                    <div class="single-product">
                                        ...
                                        <div class="product-content text-center text-uppercase">
                                            <a href="product-details.php" title="Tomas Box Logo T-Shirt">Tomas Box Logo T-Shirt</a>
                                            <div class="rating-icon">
                                                <i class="zmdi zmdi-star"></i>
                                                <i class="zmdi zmdi-star"></i>
                                                <i class="zmdi zmdi-star"></i>
                                ...
                                <div class="col-md-3 col-sm-4">
                                    ...
                                    <div class="single-product">
                                        ...
                                        <div class="product-content text-center text-uppercase">
                                            <a href="product-details.php" title="Shirt in Bee Print">Shirt in Bee Print</a>
                                            <div class="rating-icon">
                                                <i class="zmdi zmdi-star"></i>
                                                <i class="zmdi zmdi-star"></i>
                                                <i class="zmdi zmdi-star"></i>
                                ...
                                <div class="col-md-3 hidden-sm">
                                    <div class="single-product mb-40">
                                        ...
                                        <div class="product-content text-center text-uppercase">
                                            <a href="product-details.php" title="Skinny In Charcoal">Skinny In Charcoal</a>
                                            <div class="rating-icon">
                                                <i class="zmdi zmdi-star"></i>
                                                <i class="zmdi zmdi-star"></i>
                                                <i class="zmdi zmdi-star"></i>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="single-item text-white pl-120">
                                <i class="zmdi zmdi-shopping-cart"></i>
                                <h4>FREE SHIPPING</h4>
                                <p>free shipping from all around the world</p>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="single-item text-white pl-120">
                            ...
                            <div class="sale-list">
                                <div class="sinlge-sale mb-30 clearfix">
                                    <div class="row">
                                        <div class="col-xs-6">
                                            <div class="sale-img">
                                                <a href="product-details.php" title="Men’s White Short Item">
