...
if(isset($_POST["submit_key"])&& $_POST['submit_key'] == 'submit_value')
{
	...
	if($msg == "")
	{
		...
		if($ImageFile!='')
		{
			...
			$ext = end($ext);
			$ImageFile = 'U-'.$UserID.'.'.$ext;
			$moved = move_uploaded_file($_FILES['ImageFile']['tmp_name'],DIR_UPLOADING_USERS.$ImageFile);
			if($moved)
			{
				$sql = "UPDATE users SET Image = '".$ImageFile."' WHERE ID = ".$UserID;
				// echo $sql;
				// exit();
...
{
	$sql = "SELECT ID,Username,RoleID,Password,Address,Cellnumber,NIC,Image,EmailAddress,Status FROM users WHERE ID ='".$UserID."'";
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo $self;?>?UserID=<?php echo $UserID; ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
						<img style="width:150px;" src="<?php echo DIR_UPLOADING_USERS.$ImageFile?>"/>
                  </div>
                </div>
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputEmail3" name="Firstname" value="<?php echo $Username; ?>" placeholder="Enter Username">
                  </div>
                </div>
				...
				<div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputEmail3" name="Cellnumber" value="<?php echo $Cellnumber; ?>" placeholder="Enter Cell Number">
                  </div>
                </div>
                 <div class="form-group">
