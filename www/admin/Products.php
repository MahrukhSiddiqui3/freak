        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <button style="float:right; margin-right:10px;" type="button" onClick="location.href='AddNewProduct.php'" class="btn btn-sm btn-info">Add</button>	
            </div>
			<?php
			...
			<form action="<?php echo $self; ?>" id="formdel" method="post" >
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td><?php echo get_categoryname($row['CatIDs']);?></td>
                  <td><img style="width:60px;" src="<?php echo DIR_UPLOADING_PRODUCTS.$row['Image'];?>" /></td>
                  ...
                  <td><button type="button" onClick="location.href='EditProduct.php?ProductID=<?php echo $row['ID']; ?>'" class="btn btn-sm btn-info">Edit</button></td>
                </tr>
                </tbody>
                <?php
				}
