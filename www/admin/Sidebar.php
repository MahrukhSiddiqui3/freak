      ...
      <ul class="sidebar-menu">
		...
		?>
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="Roles.php"><i class="fa fa-circle-o"></i>Slider</a></li>
            <li><a href="Users.php"><i class="fa fa-circle-o"></i>Logo</a></li>
            <li><a href="Brand_area.php"><i class="fa fa-circle-o"></i>Brands</a></li>
          </ul>
        </li>
		<?php
		}
