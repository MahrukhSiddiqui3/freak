...
$sql = "SELECT u.ID,r.RoleName,u.Username,u.RoleID,u.Cellnumber,u.Address,u.NIC,u.Image,u.Status,u.EmailAddress,DATE_FORMAT(u.DateAdded,'%b %d %Y %h:%i %p') as Added ,DATE_FORMAT(u.DateModified,'%b %d %Y %h:%i %p') as Updated FROM users u LEFT JOIN roles r ON u.RoleID = r.ID WHERE u.ID <> 0";
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
			  ...
			  <button style="float:right; margin-right:10px;" type="button" onClick="location.href='AddNewUser.php'" class="btn btn-sm btn-info">Add</button>
            </div>
			<?php
			...
			<form action="<?php echo $self; ?>" id="formdel" method="post" >
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><img style="width:60px;" src="<?php echo DIR_UPLOADING_USERS.$row['Image'];?>" /></td>
